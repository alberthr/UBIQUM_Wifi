...
test <- vd
model <- readRDS("./modelos_caret/longitude_b0.rds")
test[is.na(test)] <- 0
...
test <- vd
model <- readRDS("./modelos_caret/longitude_b1.rds")
test[is.na(test)] <- 0
...
test <- vd
model <- readRDS("./modelos_caret/longitude_b2.rds")
test[is.na(test)] <- 0
...
test <- vd
model <- readRDS("./modelos_caret/latitude_b0.rds")
test[is.na(test)] <- 0
...
test <- vd
model <- readRDS("./modelos_caret/latitude_b1.rds")
test[is.na(test)] <- 0
...
test <- vd
model <- readRDS("./modelos_caret/latitude_b2.rds")
test[is.na(test)] <- 0
